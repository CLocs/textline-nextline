...
Confirm a friends/auth/inbox/groups route is **200**, not **404** (`POST /api/friends/invite`, `GET /api/groups`, or `GET /api/inbox` with a session, or `GET /api/auth/config`).
